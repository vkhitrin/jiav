...
from jiav import manifest
from jiav import content
    ...
    for issue in issues:
        ...
        if isinstance(jiav_manifest, manifest.Manifest):
            ...
            if desired_status == current_status:
                jiav_logger.info(
                    f"""Issue '{issue}' is already in the desired status '{desired_status}'"""
                )
                break
            ...
            if not dry_run:
                ...
                if upload_attachment:
                    ...
                    try:
                        ...
                        jiav_logger.error(
                            "Failed to create attachment, no execution output in manifest execution"
                        )
